      ...
      <div className="mx-auto max-w-[1200px] px-4 sm:px-6 py-12">
        ...
        <div className="mt-10 border-t border-white/10 pt-6 text-sm text-white/60 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            {/* Social Media Icons */}
            <a
              href="https://www.instagram.com/kaplanlarincir/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-white/60 hover:text-[#CDE2D8] transition-colors duration-300"
            ...
            <a
              href="https://www.linkedin.com/company/kaplanlarfig"
              target="_blank"
              rel="noopener noreferrer"
              className="text-white/60 hover:text-[#CDE2D8] transition-colors duration-300"
